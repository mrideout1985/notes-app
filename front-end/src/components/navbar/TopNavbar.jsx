    ...
    return (<AppBar position="static" className={styles.navbar}>
			<Toolbar className={styles.toolbar} variant="dense">
				<Box component="div" className={styles.content}>
					<IconButton className={styles.sidebartoggler} aria-label="Toggle sidebar" onClick={sideBarOpen}>
					...
					<UserNavDropdown currentUser={currentUser} handleLogout={handleLogout}/>
				</Box>
			</Toolbar>
		</AppBar>);
};
